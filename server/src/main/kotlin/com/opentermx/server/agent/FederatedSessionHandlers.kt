...
class FederatedListSessionsHandler(private val registry: AgentRegistry) : ToolHandler {
...
class FederatedInspectSessionHandler(private val registry: AgentRegistry) : ToolHandler {
